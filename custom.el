(custom-set-variables
 ...
 '(package-selected-packages
   '(forge multiple-cursors magit esxml treemacs async cliphist counsel-css counsel-projectile counsel swiper ivy-bibtex ivy-purpose ivy-rtags ivy-yasnippet ivy popweb ws-butler flycheck-rust pyenv-mode emmet-mode aggressive-indent restart-emacs lorem-ipsum conda multi-line rubocopfmt spacemacs-purpose-popwin spacemacs-whitespace-cleanup company-plsense fish-mode company-c-headers esh-help spaceline-all-the-icons column-enforce-mode pangu-spacing hide-comnt command-log-mode toml-mode compleseus-spacemacs-help org-ref tagedit flycheck-rtags company-web emoji-cheat-sheet-plus undo-tree fuzzy cmake-mode flycheck-bashate company-shell hyperbole rime ligature google-translate symon org-pomodoro insert-shebang pip-requirements keycast flyspell-popup company-math vim-powerline journalctl-mode json-mode indent-guide nix-mode quickrun flycheck-pos-tip emacs-everywhere eval-sexp-fu company-statistics eaf graphviz-dot-mode livid-mode treemacs-all-the-icons aweshell magic-latex-buffer rvm consult-projectile poetry rubocop pyim-basedict elisp-slime-nav zoom-window evil-lisp-state web-beautify sql-indent org-fc link-hint mmm-mode markdown-toc ruby-refactor paradox info+ seeing-is-believing highlight-numbers systemd help-fns+ org-rich-yank popwin watch-other-window uuidgen eyebrowse emamux ibuffer-projectile diminish window-purpose company-quickhelp git-gutter-fringe+ lsp-bridge chinese-conv pydoc org-auto-tangle symbol-overlay eshell-z rake macrostep json-reformat engine-mode cython-mode auto-dictionary font-lock+ rainbow-delimiters holy-mode acm subed google-c-style drag-stuff tree-sitter-langs org-appear consult-yasnippet company-reftex nov sphinx-doc gitignore-templates web-mode auto-compile smeargle typo-suggest dired-quick-sort expand-region cargo evil-cleverparens ruby-test-mode highlight-parentheses devdocs npm-mode flx-ido git-link evil-evilified-state git-modes unkillable-scratch scss-mode org-transclusion org-fragtog org-contrib py-isort yapfify define-word multi-vterm browse-at-remote nameless hybrid-mode highlight-indentation rspec-mode org-superstar nose rbenv ace-link nodejs-repl robe eshell-prompt-extras consult-dir js2-refactor minitest toc-org bundler fancy-battery org-roam-bibtex embark-consult centered-cursor-mode wgrep shell-pop consult-company company-ycmd adoc-mode dumb-jump org-web-tools clean-aindent-mode flyspell-correct-popup blacken org-mime org-vcard ebib ron-mode org-present treemacs-icons-dired cpp-auto-include demo-it pdf-view-restore company-nixos-options org-wild-notifier pylookup ruby-tools find-by-pinyin-dired xterm-color jupyter auto-highlight-symbol treemacs-persp csv-mode sqlup-mode cmake-ide company-rtags disaster hardhat gif-screencast treemacs-magit company-tabnine all-the-icons-ibuffer password-generator chruby ob-tmux golden-ratio org-roam-ui org-noter-pdftools hl-todo impatient-mode gendoxy orderless importmagic unfill org-download magit-gitflow fancy-narrow dotenv-mode mwim slim-mode org-tree-slide auto-yasnippet multi-term shfmt company-auctex org-cliplink editorconfig youdao-dictionary racer which-key open-junk-file ts-fold winum gh-md org-contacts company-box inspector ace-pinyin hungry-delete elisp-def git-messenger js-doc cdlatex consult-org-roam dockerfile-mode space-doc live-py-mode pyim sass-mode pug-mode ruby-hash-syntax orgit-forge flycheck-ycmd company-emoji prettier-js flycheck-package vertico pytest all-the-icons-dired yaml-mode emr overseer yasnippet-snippets volatile-highlights plantuml-mode emojify code-cells json-navigator flycheck-elsa pippel string-edit-at-point term-cursor docker gnuplot company-anaconda ox-hugo terminal-here treemacs-projectile ox-epub ac-ispell pipenv marginalia git-timemachine writeroom-mode))
