(custom-set-variables
 ...
 '(org-roam-capture-templates
   '(("d" "fleeting (default)" entry "* NEW %^{title}    :fleeting:\12:LOGBOOK:\12- Create time: %U\12- From: %a\12- Tags: [ add reference notes ]\12- See also: [ add fleeting and permanent notes ]\12- Areas: [ add areas-of-responsibility ]\12:END:" :target
     ...
     ("g" "glossary" plain "%?" :target
      (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\12#+filetags: glossary\12# Time-stamp:  %U\12- 📆Create time: %U\12- ✨Create from: %a\12- 🏷️Tags:  [ add reference notes ]\12- 🧭Compass:\12  + 🔼North:\12  + ◀️West:\12  + ▶️East:\12  + 🔽South:\12\12* ℹ️About ${title}\12\12[ basic information ]\12\12* 📚References")
     ...
     ("s" "software" plain "%?" :target
      (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\12#+filetags: reference\12# Time-stamp:  %U\12- Create time: %U\12- Tags:  [[roam:software]], [ add reference notes ]\12- See also: [ add fleeting and permanent notes ]\12\12* About ${title}\12\12[ Logo image ]\12[ TL;DR - basic information about ${title} ]\12\12* Resources\12\12* Concepts and Terminology\12\12* Install, Uninstall and Update\12\12* Configuration\12\12* Usage\12\12** Basic usage\12\12** Use cases\12\12* Tricks & Tips")
 ...
 '(package-selected-packages
   '(all-the-icons consult embark package-lint magit magit-section projectile async tern git-gutter-fringe git-gutter treemacs-icons-dired treemacs-magit treemacs-persp treemacs-projectile treemacs ws-butler flycheck-rust pyenv-mode emmet-mode aggressive-indent restart-emacs lorem-ipsum conda multi-line rubocopfmt spacemacs-purpose-popwin spacemacs-whitespace-cleanup diff-hl company-plsense fish-mode company-c-headers lsp-bridge esh-help subed spaceline-all-the-icons column-enforce-mode pangu-spacing hide-comnt command-log-mode toml-mode compleseus-spacemacs-help tagedit flycheck-rtags company-web emoji-cheat-sheet-plus ivy-bibtex undo-tree fuzzy flycheck-bashate company-shell hyperbole rime google-translate symon org-pomodoro insert-shebang pip-requirements keycast flyspell-popup company-math vim-powerline journalctl-mode json-mode indent-guide nix-mode quickrun flycheck-pos-tip emacs-everywhere eval-sexp-fu company-statistics eaf graphviz-dot-mode livid-mode aweshell magic-latex-buffer rvm consult-projectile poetry rubocop pyim-basedict elisp-slime-nav zoom-window evil-lisp-state persp-mode web-beautify sql-indent org-fc link-hint mmm-mode markdown-toc ruby-refactor paradox info+ seeing-is-believing highlight-numbers systemd help-fns+ org-rich-yank popwin disaster watch-other-window uuidgen eyebrowse emamux ibuffer-projectile diminish company-quickhelp chinese-conv pydoc org-auto-tangle symbol-overlay ivy-yasnippet eshell-z rake json-reformat macrostep tree-sitter-langs engine-mode cython-mode auto-dictionary font-lock+ rainbow-delimiters holy-mode google-c-style drag-stuff org-appear consult-yasnippet company-reftex nov sphinx-doc gitignore-templates web-mode adoc-mode smeargle org-ref typo-suggest dired-quick-sort expand-region cargo evil-cleverparens ruby-test-mode highlight-parentheses devdocs npm-mode flx-ido git-link evil-evilified-state git-modes unkillable-scratch scss-mode org-transclusion ivy-purpose org-fragtog org-contrib py-isort yapfify define-word multi-vterm browse-at-remote nameless hybrid-mode highlight-indentation rspec-mode org-superstar nose rbenv ace-link nodejs-repl robe pyim eshell-prompt-extras cfrs consult-dir js2-refactor minitest toc-org bundler fancy-battery org-roam-bibtex auto-compile embark-consult centered-cursor-mode wgrep shell-pop consult-company company-ycmd dumb-jump company-box org-web-tools clean-aindent-mode flyspell-correct-popup blacken org-mime org-vcard ebib ron-mode org-present cpp-auto-include demo-it pdf-view-restore company-nixos-options org-wild-notifier pylookup ruby-tools find-by-pinyin-dired xterm-color jupyter auto-highlight-symbol csv-mode sqlup-mode cmake-ide company-rtags ace-window gif-screencast company-tabnine all-the-icons-ibuffer password-generator chruby ob-tmux golden-ratio org-roam-ui org-noter-pdftools hl-todo impatient-mode gendoxy orderless importmagic unfill org-download magit-gitflow fancy-narrow dotenv-mode mwim slim-mode org-tree-slide auto-yasnippet multi-term shfmt company-auctex org-cliplink editorconfig youdao-dictionary racer which-key open-junk-file ts-fold cmake-mode winum gh-md org-contacts ace-pinyin hungry-delete elisp-def git-messenger js-doc cdlatex consult-org-roam counsel-css dockerfile-mode space-doc live-py-mode counsel-projectile sass-mode pug-mode ruby-hash-syntax orgit-forge inspector flycheck-ycmd company-emoji cliphist ivy-rtags prettier-js flycheck-package popweb vertico pytest all-the-icons-dired yaml-mode emr overseer yasnippet-snippets volatile-highlights plantuml-mode emojify code-cells json-navigator flycheck-elsa pippel string-edit-at-point term-cursor docker gnuplot company-anaconda ox-hugo terminal-here pfuture ox-epub ac-ispell pipenv marginalia git-timemachine writeroom-mode))
