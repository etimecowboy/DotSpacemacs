;; -*- mode: emacs-lisp -*-
;; Time-stamp: <2020-05-13 星期三 11:06 by xin on legion>
...
values."
  (setq-default
   ...
   '(
     ...
     emacs-lisp
     git
     ;; github # gives Error (use-package): magit-gh-pulls/:catch: Key sequence j q starts with non-prefix key j
     markdown
     (shell :variables
