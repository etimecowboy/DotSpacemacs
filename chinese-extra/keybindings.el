...
;; Time-stamp: <2024-04-29 Mon 09:13:25 GMT by xin on tufg>
...
(global-set-key (kbd "C-S-<f8>") 'google-translate-smooth-translate)
(global-set-key (kbd "M-S-<f8>") 'google-translate-paragraphs-overlay)
(global-set-key (kbd "M-<f8>") 'xy/en-en-dict-at-point)
(global-set-key (kbd "<f8>")   'xy/simple-dict-at-point)
(global-set-key (kbd "S-<f8>") 'xy/record-word-at-point)
