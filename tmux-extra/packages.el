...
;; Time-stamp: <2022-04-04 Mon 02:43 by xin on tufg>
...
(defun tmux-extra/init-emamux ()
  ...
  (use-package emamux
    :ensure t
    :config
    (global-set-key (kbd "M-z") emamux:keymap) ;; NOTE: my tmux prefix key is
                                               ;; also M-z, so I have to M-z M-z
                                               ;; when using emacs in tmux.
